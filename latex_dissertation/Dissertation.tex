...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{dissertation_images/moderate-complexity_topology.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../../dissertdissertation_images_and_stuff/architecture_diagram_design.png}
    \caption{Your caption here}
    \label{fig:my-image2}
\end{figure}

\autoref{fig:my-image2} 
